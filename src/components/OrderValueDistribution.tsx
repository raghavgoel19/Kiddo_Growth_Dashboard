...
import type { OrderValueBucket } from '../api/types'
...
function CustomTooltip({ active, payload }: { active?: boolean; payload?: { payload: OrderValueBucket }[] }) {
...
export function OrderValueDistribution({ data }: OrderValueDistributionProps) {
  return (
    <div className="overflow-x-auto">
      <ResponsiveContainer width="100%" height={280} minWidth={360}>
        <BarChart data={data}>
          <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" vertical={false} />
          <XAxis dataKey="label" tick={{ fontSize: 10, fill: '#64748b' }} interval={0} angle={-25} textAnchor="end" height={56} axisLine={false} tickLine={false} />
